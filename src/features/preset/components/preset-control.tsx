...
import { KitNavigator } from "@/features/kit/components/kit-navigator";
import { KitSelect } from "@/features/kit/components/kit-select";
import { PresetActions } from "@/features/preset/components/preset-actions";
...
const SaveAsDialog = lazy(() =>
  import("@/features/preset/dialogs/save-as-dialog").then((module) => ({
    default: module.SaveAsDialog,
  })),
);

const ExportDialog = lazy(() =>
  import("@/features/preset/dialogs/export-dialog").then((module) => ({
    default: module.ExportDialog,
  })),
);

const ShareDialog = lazy(() =>
  import("@/features/preset/dialogs/share-dialog").then((module) => ({
...
const DuplicatePresetDialog = lazy(() =>
  import("@/features/preset/dialogs/duplicate-preset-dialog").then(
    (module) => ({
...
const DeleteConfirmDialog = lazy(() =>
  import("@/features/preset/dialogs/delete-confirm-dialog").then((module) => ({
    default: module.DeleteConfirmDialog,
  })),
);

const ConfirmSelectPresetDialog = lazy(() =>
  import("@/features/preset/dialogs/confirm-select-preset-dialog").then(
    (module) => ({
